...
import { Check, Star, Award, Shield, Target, Zap, Crown, Gem, Users, Globe, Play } from 'lucide-react';
...
const sponsorshipTiers = [
    {
        ...
        price: "₹25,00,000",
        type: "Exclusive",
        shortDesc: "Best for: Large brands, tourism boards, luxury chains",
        icon: <Crown className="text-yellow-500" size={32} />,
        color: "from-yellow-400 to-yellow-600",
        benefits: [
            "“Presented By / Title Sponsor” branding across all platforms",
            "Prime pavilion space (200–400 sqm)",
            "Logo on: Entry gate / registration area, Main stage backdrop, All marketing creatives",
            "Dedicated Pavilion Naming Rights (e.g., “Dubai Luxury Pavilion – Presented by XYZ”)",
            "Speaking slot / stage presentation",
            "Featured in PR, media & influencer coverage",
            "Database access (premium leads)",
            "20 VIP passes + 50 exhibitor passes",
            "Social media campaign (pre + during event)"
        ]
    },
    {
        name: "Gold Sponsor",
        price: "₹10,00,000",
        type: "Tier 1",
        shortDesc: "Best for: Established brands, national players",
        icon: <Gem className="text-amber-500" size={32} />,
        color: "from-amber-300 to-amber-500",
        benefits: [
            "“Powered By / Gold Sponsor” branding",
            "Premium booth space (100–150 sqm)",
            "Logo on: Website homepage, Event creatives, Backdrops (secondary placement)",
            "Category Exclusivity (if applicable)",
            "Participation in fashion show / experience zone",
            "10 VIP passes + 25 exhibitor passes",
            "Lead sharing (filtered database)"
        ]
    },
    {
        name: "Silver / Associate Sponsor",
        price: "₹5,00,000",
        type: "Tier 2",
        shortDesc: "Best for: Growing brands, regional players",
        icon: <Award className="text-gray-400" size={32} />,
        color: "from-gray-300 to-gray-400",
        benefits: [
            "“Associate Sponsor” branding",
            "Standard booth (50–80 sqm)",
            "Logo on website + select creatives",
            "Branding in specific zone (food, decor, etc.)",
            "5 VIP passes + 15 exhibitor passes",
            "Lead support (inquiry-based sharing)"
        ]
    },
    {
        ...
        price: "₹3,00,000",
        type: "Tier 3",
        shortDesc: "Best for: Entry-level sponsors / niche brands",
        icon: <Star className="text-blue-400" size={32} />,
        color: "from-blue-200 to-blue-300",
        benefits: [
            "“Supporting Partner” mention",
            "Small booth (24–40 sqm)",
            "Logo on website (partners section)",
            "Branding in common areas",
            "2 VIP passes + 10 exhibitor passes",
            "Basic lead exposure"
        ]
    }
];
...
const experienceSponsors = [
    { name: "Stage Partner", price: "₹15L" },
    { name: "Fashion Show Partner", price: "₹7L" },
    { name: "VIP Lounge Partner", price: "₹5L" },
    { name: "Registration Partner", price: "₹3L" },
    { name: "Networking Partner", price: "₹4L" },
    { name: "Digital Partner", price: "₹3L" },
    { name: "Gifting Partner", price: "₹2L" },
    { name: "Entertainment Partner", price: "₹5L" },
];
