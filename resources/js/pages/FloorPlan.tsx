...
const FloorPlan = () => {
    ...
    React.useEffect(() => {
        if (isSubmitted) {
            ...
            link.href = '/map.pdf';
            link.download = 'wedding-expo-map.pdf';
            link.target = '_blank';
                    ...
                    <div className="max-w-7xl mx-auto px-6 relative z-10">
                        ...
                        >
                            <h1 className="text-[48px] md:text-[64px] font-bold leading-tight mb-6">
                                Download <span className="text-[--gold]">Expo Map</span>
                            </h1>
                            <p className="text-[18px] md:text-[20px] text-gray-300 leading-relaxed mb-8">
                                Discover the layout of Wedding India Expo 2026 at Yashobhoomi. Plan your journey through our themed pavilions, luxury zones, and experience arenas.
                            </p>
                        </motion.div>
                    </div>
                </div>
                                ...
                                {!isSubmitted ? (
                                    <div className="bg-white rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] p-8 md:p-10 border border-gray-50">
                                        <div className="mb-10">
                                            ...
                                            <h3 className="text-[28px] font-bold text-[#191919]">
                                                {step === 1 ? 'Get the Expo Map' : 'Company Details'}
                                            </h3>
                                    ...
                                    >
                                        ...
                                        <p className="text-gray-600 text-[17px] mb-10">
                                            Thank you for your interest. Your Expo Map download should start automatically within a few seconds.
                                        </p>
